...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coordinator_question.open_until'
        db.add_column(u'volunteers_coordinator_question', 'open_until',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 7, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coordinator_question.open_until'
        db.delete_column(u'volunteers_coordinator_question', 'open_until')
    ...
    models = {
        ...
        u'volunteers.coordinator_question': {
            ...
            'date_time': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'open_until': ('django.db.models.fields.DateField', [], {}),
