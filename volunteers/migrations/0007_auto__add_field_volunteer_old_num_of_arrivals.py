...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Volunteer.old_num_of_arrivals'
        db.add_column(u'volunteers_volunteer', 'old_num_of_arrivals',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Volunteer.old_num_of_arrivals'
        db.delete_column(u'volunteers_volunteer', 'old_num_of_arrivals')
