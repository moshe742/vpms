...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Volunteer.relevant_info'
        db.add_column(u'volunteers_volunteer', 'relevant_info',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=999, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Volunteer.relevant_info'
        db.delete_column(u'volunteers_volunteer', 'relevant_info')
