...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Volunteer.birth_date'
        db.alter_column(u'volunteers_volunteer', 'birth_date', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'Volunteer.birth_date'
        db.alter_column(u'volunteers_volunteer', 'birth_date', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        u'volunteers.volunteer': {
            ...
            'birth_date': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
