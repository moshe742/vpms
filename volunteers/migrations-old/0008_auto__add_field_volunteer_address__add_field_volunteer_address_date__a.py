...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'volunteers_volunteer', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Volunteer.address_date'
        db.add_column(u'volunteers_volunteer', 'address_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 6, 9, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Volunteer.work_study_place'
        db.add_column(u'volunteers_volunteer', 'work_study_place',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Volunteer.work_study_place_date'
        db.add_column(u'volunteers_volunteer', 'work_study_place_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 6, 9, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'volunteers_volunteer', 'address')

        # Deleting field 'Volunteer.address_date'
        db.delete_column(u'volunteers_volunteer', 'address_date')

        # Deleting field 'Volunteer.work_study_place'
        db.delete_column(u'volunteers_volunteer', 'work_study_place')

        # Deleting field 'Volunteer.work_study_place_date'
        db.delete_column(u'volunteers_volunteer', 'work_study_place_date')
    ...
    models = {
        ...
        u'volunteers.volunteer': {
            ...
            'address_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'old_num_of_arrivals': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'twitter': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'work_study_place': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'work_study_place_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
